...
namespace SFA.DAS.Experiments.Models.Marketo
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseOfCustomActivity :  IEquatable<ResponseOfCustomActivity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseOfCustomActivity" /> class.
        /// </summary>
        [JsonConstructor]
        protected ResponseOfCustomActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseOfCustomActivity" /> class.
        /// </summary>
        ...
        public ResponseOfCustomActivity(List<Error> errors = default(List<Error>), bool moreResult = default(bool), string nextPageToken = default(string), string requestId = default(string), List<CustomActivity> result = default(List<CustomActivity>), bool success = default(bool), List<Warning> warnings = default(List<Warning>))
        {
            // to ensure "errors" is required (not null)
            if (errors == null)
            {
                throw new InvalidDataException("errors is a required property for ResponseOfCustomActivity and cannot be null");
            }
            else
            {
                this.Errors = errors;
            ...
            if (requestId == null)
            {
                throw new InvalidDataException("requestId is a required property for ResponseOfCustomActivity and cannot be null");
            }
            else
            {
            ...
            if (result == null)
            {
                throw new InvalidDataException("result is a required property for ResponseOfCustomActivity and cannot be null");
            }
            else
            {
                this.Result = result;
            ...
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for ResponseOfCustomActivity and cannot be null");
            }
            else
            {
            ...
            if (warnings == null)
            {
                throw new InvalidDataException("warnings is a required property for ResponseOfCustomActivity and cannot be null");
            }
            else
            {
        ...
        public List<CustomActivity> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseOfCustomActivity {\n");
        ...
        {
            return this.Equals(input as ResponseOfCustomActivity);
        }

        /// <summary>
        /// Returns true if ResponseOfCustomActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseOfCustomActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseOfCustomActivity input)
        {
            if (input == null)
                return false;
